...
describe("CalendarDialog Component", () => {
    ...
    it("renders the Cancel button", () => {
        cy.get(`[data-testid=${CALENDAR_DIALOG_CANCEL_BUTTON_DATA_TEST_ID}]`).should("exist");
    });
    it('renders confirm button', () => {
        cy.get(`[data-testid=${CALENDAR_DIALOG_CONFIRM_BUTTON_DATA_TEST_ID}]`).should('exist')
    });
    it('renders today button', () => {
        cy.get(`[data-testid=${CALENDAR_DIALOG_TODAY_BUTTON_DATA_TEST_ID}]`).should('exist')
    });
    ...
    it("calls the onConfirm prop when the Confirm button is clicked", () => {
        cy.get(`[data-testid=${CALENDAR_DIALOG_CONFIRM_BUTTON_DATA_TEST_ID}]`).click();
    ...
    it("calls onRefeshToday when the 'Today' button is clicked", () => {
        cy.get(`[data-testid=${CALENDAR_DIALOG_TODAY_BUTTON_DATA_TEST_ID}]`).click();
